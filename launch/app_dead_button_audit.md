# BreakWave — BW-67 App-Wide Dead Button Audit

## Purpose

BW-67 removes launch-risk dead actions and unfinished app-facing copy.
...
Buttons in BreakWave should either perform a real action, open a real route, save real data, or clearly explain the next step.
